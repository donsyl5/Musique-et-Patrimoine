...
// Recipients
$fromEmail = 'donsyl5@yahoo.fr'; // Email address that will be in the from field of the message.
$fromName = 'Musique et Patrimoine'; // Name that will be in the from field of the message.

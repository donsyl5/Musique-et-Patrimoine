              ...
              {         
                  ...
                  if($filename){
						...
						$image = $titre_image.'.'.$imageFileType;
						  ...
						  $sql = "UPDATE presentation SET texte=:texte, image=:image, date_creation=:date_creation";
                        ...
                        if($result['image']!=$image){
						  ...
						  $sql = "UPDATE presentation SET texte=:texte, date_creation=:date_creation";
						  $req1 = $bdd->prepare($sql);
						  $req1->execute(array(
							'texte' => $texte,
							'date_creation' => $date
			...
			<form role="form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label>Texte presentation</label>
                ...
                <div class="form-group">
					<label for="exampleInputFile">Image presentation</label>
					<?php 

              ...
              {         
                  ...
                  if($filename){
						...
						$image = $titre_image.'.'.$imageFileType;
						  ...
						  $sql = "UPDATE orgue SET texte=:texte, image=:image, date_creation=:date_creation";
                        ...
                        if($result['image']!=$image){
						  ...
						  $sql = "UPDATE orgue SET texte=:texte, date_creation=:date_creation";
						  $req1 = $bdd->prepare($sql);
						  $req1->execute(array(
							'texte' => $texte,
							'date_creation' => $date
		...
		?>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Nos orgues</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
			...
			<form role="form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
					<label for="exampleInputFile">Image Nos orgues</label>
					<?php 

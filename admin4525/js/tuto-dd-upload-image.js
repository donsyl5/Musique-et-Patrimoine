    $(document).ready(function() {
    	var id_album =document.form1.id_album.value;
    	...
    	function upload(files){ // upload function
    		...
    		$.ajax({ // JQuery Ajax
    			type: 'POST',
    			url: 'tuto-dd-upload-image.php?id_album='+id_album+'', // URL to the PHP file which will insert new value in the database

        ...
        <div class="col-md-10">
          <?php 
            ...
            { if(!empty($_POST['titre'])){
				...
				$heure=$_POST['heure'];
				$date = date("Y-m-d"); 
				/*$dateObject = DateTime::createFromFormat('d/m/Y', $date_evenement);
				$mysqlDate = $dateObject->format('Y-m-d');*/
				  $req = $bdd->prepare('INSERT INTO evenement(titre,date_evenement, type_evenement, heure, date_creation) VALUES(:titre, :date_evenement, :type_evenement, :heure, :date_creation)');
				  $req->execute(array(
				  'titre' => $titre,
				  ...
				  echo '<div class="alert alert-success" role="alert"><strong>Oh well!</strong> Evènement enregistré avec succès</div>';
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Créer un nouvel événement</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="titre" placeholder="Entrer le titre d'évènement"  value="<?php if(!empty($_POST['titre'])){ echo $_POST['titre'];}?>" required>
                </div>
                <div class="form-group">
				...
				<!--div class="form-group">
				  ...
				  <textarea id="editor1" name="detail" rows="6" cols="80" placeholder="Entrer la détail de l'évènement ici"><?php //if(!empty($_POST['detail'])){ echo $_POST['detail'];}?></textarea>
                </div-->
                <div class="form-group">
					...
					<div class="input-group date">
					  ...
					  <input type="date" id="date" name="date_evenement" class="form-control pull-right" id="datepicker">
					</div>
					<!-- /.input group -->
                </div>
                <div class="form-group">
                  <label for="heure">Heure de l'évènement</label>
                  <input type="text" class="form-control" name="heure" placeholder="Heure de l'évènement"  value="<?php if(!empty($_POST['heure'])){ echo $_POST['heure'];}?>" required>
                </div>
              </div>
              <!-- /.box-body -->
